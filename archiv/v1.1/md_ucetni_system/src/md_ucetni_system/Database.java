...
public class Database extends Printer
{
    ...
    public boolean connect_db()
    {
        try
        {
            ...
            con = DriverManager.getConnection("jdbc:mysql://192.168.0.142:3306/property", "cashdesk", "asdfghjkl");
    ...
    public String get_item_shortcut_name_by_ID(int ID)
    {
        if(this.is_connected() == true)
        {
            /*
